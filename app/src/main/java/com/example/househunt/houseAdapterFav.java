...
public class houseAdapterFav extends RecyclerView.Adapter<houseAdapterFav.houseViewHolder> {

    ArrayList<houseItem> houseItems = new ArrayList<>();

    houseAdapterFav(ArrayList<houseItem> houseItems)
    {
    ...
    public houseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.house_item_fav,parent,false);
